...
D3.initPeople = function() {
    ...
    //copies the interst node information--not sure why
    ...
    var arc = d3.svg.arc()
        //radius of circle inwhich the picture is
        .innerRadius(14)
        //radius circle where all the colors are
        .outerRadius(22);
    //fills in the outer circle with the apropriate distribution.
    var pie = d3.layout.pie()
        .sort(null)
        .value(function(d) { return d.value; });

      //outside of circle lines  and wedges
    groups.append("g")
        .selectAll("path")
        .data(function (d) {
...
var interestJson = {"people":{
    "15830":{"id":15830, "fid":250588901, "name":"Luther Rea", "pic":"/Macademia/all/image/fake?gender=male&img=00285_940422_fa.png", "relevance":{"-1":null, "976":1.1539017856121063, "24":1, "overall":1.0769508928060532},
        "count":{"-1":15, "976":2, "24":1, "overall":3},
        "interests":[10262, 11870, 1438, 15829, 462, 3869, 1476, 15827, 15826, 15836, 15833, 16179, 15832, 15835, 15834, 10987, 15828, 24]},
    "16":{"id":16, "fid":257, "name":"Donnie Burroughs",
    ...
    "2691":{"id":2691, "fid":7241482, "name":"Diana Brooks",
    ...
    "2375":{"id":2375, "name":"algebraic geometry", "cluster":1501, "relevance":0.6078913807868958, "roles":[]},
    "21":{"id":21, "name":"politics", "cluster":21, "relevance":0, "roles":[]}, "1438":{"id":1438,
