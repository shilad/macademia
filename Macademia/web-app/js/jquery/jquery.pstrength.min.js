(function(a) {
    a.extend(a.fn, {pstrength:function(b) {
        var b = a.extend({verdects:["Very weak","Weak","Medium","Strong","Strongest"],colors:["#f00","#c06","#f60","#3c0","#3d0"],scores:[10,15,30,40],common:["password","sex","god","123456","123","liverpool","letmein","qwerty","monkey"],minchar:5}, b);
